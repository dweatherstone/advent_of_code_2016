...
Unfortunately, the screen has been smashed. After a few minutes, you've taken everythng apart and figured out how it works. Now you just have to work out what the screen **would** have displayed.
...
- `rotate column x=1 by 1` rotates the second colunm down by one pixel:
